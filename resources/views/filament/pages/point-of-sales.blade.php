                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <div class="flex items-center mt-2">
                                ...
                                <p class="text-2xl font-bold text-gray-900 dark:text-white ml-3">{{ $monthlyTotal }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <div class="flex items-center mt-2">
                                ...
                                <p class="text-2xl font-bold text-gray-900 dark:text-white ml-3">{{ $dailyTotal }}</p>
                            </div>
                        </div>
                    </div>
                </div>
